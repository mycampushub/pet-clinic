  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(errorData.error || 'Failed to create clinic')
      }
    } catch (error) {
      console.error('Error creating clinic:', error)
      setError('Error creating clinic')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900">Create New Clinic Location</h2>
          <p className="text-gray-600">
            Fill in the details below to add a new clinic location to your organization.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the clinic's location and contact details
            </CardDescription>
          </CardHeader>
          <CardContent>
